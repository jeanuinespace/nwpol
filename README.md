...
<body class="stackedit">
  <div class="stackedit__html"><h1 id="assignment1-advance-computer-networking">Assignment1: Advance Computer Networking</h1>
<p>@Author: KOAY CHEOW KHOON / A0194973L<br>
Date : 6 SEPTEMBER 2019</p>
<h1 id="policy-1">Policy 1</h1>
<p>iPerf3 Logs Test/Output Files are located at the following folder: <strong>/home/cs5229/CS5229/test/</strong></p>
<h4 id="test1">TEST1</h4>
<blockquote>
<p>To proof that TCP is working on port 1000. You may replace integer 1000 with any port number to test TCP.</p>
</blockquote>
<p>From <strong>H3 xterm:</strong> <code>iperf3 -s -p 1000 &gt; ./test/Q1/TEST1-iperf3outH3-tcp1000.txt</code><br>
** Press <code>[ctrl]+[c]</code> when the process is completed. The output file should be generated.<br>
Output file: <code>TEST1-iperf3outH3-tcp1000.txt</code></p>
<p>From <strong>H2 xterm:</strong> <code>iperf3 -c 10.0.0.3 -p 1000 &gt; ./test/Q1/TEST1-iperfH2-tcp1000.txt</code><br>
Output file: <code>TEST1-iperfH2-tcp1000.txt</code></p>
<h4 id="test2">TEST2:</h4>
<blockquote>
<p>To proof that UDP is not working on port 1000. You may replace 1000 with any number between 1000-1100. Similar error will be observed.</p>
</blockquote>
<p>From <strong>H3 xterm:</strong> <code>iperf3 -s -p 1000 &gt; ./test/Q1/TEST2-iperf3outH3-udp1000.txt</code><br>
** Press <code>[ctrl]+[c]</code> when the process is completed. The output file should be generated.<br>
On the H3 xterm, you will see <code>"iperf3: the client has unexpectedly closed the connection"</code><br>
Output file: <code>TEST2-iperf3outH3-udp1000.txt</code></p>
<p>From <strong>H2 xterm:</strong> <code>iperf3 -c 10.0.0.3 -p 1000 -u &gt; ./test/Q1/TEST2-iperfH2-udp1000.txt</code><br>
On the H2 xterm, you will see <code>"iperf3: error - unable to read from stream socket: Resource temporarily unavailable"</code><br>
Output file: <code>TEST2-iperfH2-udp1000.txt</code></p>
<h4 id="test3">TEST3:</h4>
<blockquote>
<p>Similar to TEST1, the test is to make sure we can TCP on any port number. But the server and client has been swapped.</p>
</blockquote>
<p>In this case, I’m testing with port 1100.<br>
From <strong>H2 xterm</strong>: <code>iperf3 -s -p 1100 &gt; ./test/Q1/TEST3-iperf3outH2-tcp1100.txt</code><br>
** Press [ctrl]+[c] when the process is completed. The output file should be generated.<br>
Output file: <code>TEST3-iperf3outH2-tcp1100.txt</code></p>
<p>From H3 xterm: <code>iperf3 -c 10.0.0.2 -p 1100 &gt; ./test/Q1/TEST3--iperf3H3-tcp1100.txt</code><br>
Output file: <code>TEST3-iperf3H3-tcp1100.txt</code></p>
<h4 id="test4">TEST4:</h4>
<blockquote>
<p>to TEST2, the test is to make sure we can UDP on any port number. But the server and client has been swapped.</p>
</blockquote>
<p>From <strong>H2 xterm</strong>: <code>iperf3 -s -p 1000 &gt; ./test/Q1/TEST4-iperf3outH2-udp1100.txt</code><br>
** Press <code>[ctrl]+[c]</code> when the process is completed. The output file should be generated.<br>
On the H2 xterm, you will see <code>"iperf3: the client has unexpectedly closed the connection"</code><br>
Output file: <code>TEST4-iperf3outH2-udp1100.txt</code></p>
<p>From <strong>H3 xterm:</strong> <code>iperf3 -c 10.0.0.2 -p 1100 -u &gt; ./test/Q1/TEST4-iperfH3-udp1100.txt</code><br>
On the H3 xterm, you will see <code>"iperf3: error - unable to read from stream socket: Resource temporarily unavailable"</code><br>
Output file: <code>TEST4-iperfH3-udp1100.txt*</code></p>
<h1 id="policy-2">Policy 2</h1>
<h3 id="test1-1">TEST1:</h3>
<blockquote>
<p>To check the bandwidth from H1 over to H2. The limit should be within 1Mbps.</p>
</blockquote>
<p>From <strong>xterm H2</strong>, enter: <code>iperf3 -s &gt; ./test/Q2/TEST1-h2.txt</code><br>
** Press <code>[ctrl]+[c]</code> when the process is completed. The output file should be generated.<br>
From <strong>xterm H1</strong>, enter: <code>iperf3 -c 10.0.0.2 &gt; ./test/Q2/TEST1-h1.txt</code></p>
<p>Bandwidth in h2 (TEST1-h2.txt) indicates that the bandwidth remains within 1Mbps rate.</p>
<h3 id="test2-1">TEST2:</h3>
<blockquote>
<p>To check whether the reverse is true. The bandwidth from h2 to h1 should not change (i.e. it should follow the default queue 0)</p>
</blockquote>
<p>From <strong>xterm H1</strong>, enter: <code>iperf3 -s &gt; ./test/Q2/TEST2-h1.txt</code><br>
** Press <code>[ctrl]+[c]</code> when the process is completed. The output file should be generated.<br>
From <strong>xterm H2</strong>, enter: <code>iperf3 -c 10.0.0.1 &gt; ./test/Q2/TEST2-h2.txt</code></p>
